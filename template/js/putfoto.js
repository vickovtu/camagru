	...
	window.onload = function(){
		...
		var capTureMe = function (){
			...
			reset_img = context.getImageData(0,0,320, 240);
		...
		var logo = function(){
            ...
            context.drawImage(logo, 140, 90, 60, 60);        
		}
		...
		var saveImg = function (){
            ...
            xhr.open("POST", "/camera/add/", true); // Настройка объекта для отправки синхронного GET запроса
